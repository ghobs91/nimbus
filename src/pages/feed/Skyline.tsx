...
export default function Skyline(props: {}) {
    ...
    return (
        <div className="skyline">
            {/* <Fleets /> */}
            {newPosts.length ? <button onClick={_handleNewPostsClick} className={cn("btn", styles.newPosts)}>
            ...
            <div className="col-header" ref={headerRef}>
                {window.innerWidth < 1024 ?
                    <>
                        ...
                        <h1 onClick={_scrollToTop}>Home</h1>
                    </> : <h1>Home</h1>}
                <div>
                    {!ui.hot ?
                        <button className="header-btn" onClick={_handleHot}>
                            <span>What's Hot</span><img src={HotIcon} alt="Hot Column" />
                        </button> : ''}
                </div>
            </div>
            <New />
